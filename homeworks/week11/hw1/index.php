...
<body>
  <div>
    ...
    <div class="container">
      ...
      <?php
      $sql = "SELECT * FROM board_1 WHERE parent_id=0 ORDER BY id DESC limit " . ($page-1) . ", 3";
      ...
      <div class="comments margin-top-20 relative">
        ...
        ?>
          <div class="sub_comments margin-top-10 relative">
            ...
            ?>
            <div class="sub_comment-id"><?php echo $sub_row['nickname']?></div>
            <div class="sub_comment-content"><?php echo $sub_row['content']?></div>
          </div>
        <?php
      ...
      <div class="comments margin-top-20">
        ...
        <div class="comment-content">馬克馬麗 青春點點點 推推推!!!!</div>
          <div class="sub_comments">
            <div class="sub_comment-id">正妹</div>
            <div class="sub_comment-content">馬克馬麗 青春點點點 推推推!!!!</div>
          </div>
          <form class="sub-board-write method="POST" action="./handle_comment.php">
            <div style="margin: 0 20px;">
              <div class="sub-board-name"><?php echo $username ?></div>
              <textarea class="sub-board-write-text" name="sub_comment"></textarea>
              <div class="padding-top-15 padding-bottom-15">
